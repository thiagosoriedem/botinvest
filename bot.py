...
TOKEN = "6612029475:AAHnuCrlg3ljXCG_itODvtC9FNKRFczrhLM" # mybot
...
def send_welcome(message):               # handler
    ...
    texto = ("BEM VINDO\nEste bot traz a cotação de: \nPETR4, TAEE4 e ITSA4.\nPeriodo: desde janeiro de 2020 até a data atual.\nTraz também a previsão de fechamento nos próximos 30 dias.\nVeja: /menu")
...
def webhook():
    bot.remove_webhook()
    bot.set_webhook(url='https://botinvest-d80a33f886f8.herokuapp.com/'+TOKEN)
    return "!", 200
